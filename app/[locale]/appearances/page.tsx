...
export async function generateMetadata({
  ...
  const t = await getDict(lang, "appearances");
  return { title: t.meta.title, description: t.meta.description, alternates: alternatesFor(lang, "/appearances") };
}
